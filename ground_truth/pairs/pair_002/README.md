# pair_002 — South_Polar_41E

| Field | Value |
|-------|-------|
| OHRC | `ch2_ohr_ncp_20200825T1521048453_d_img_d18` |
...
## OHRC Sensor
- Resolution: 0.2508 m/px | Dims: 93692×12000px
- UL (-68.3348°,41.0766°) UR (-68.3342°,41.3676°)
- LL (-69.1660°,41.2033°) LR (-69.1654°,41.5051°)
...
IIT confirmed. Parallel OHRC track 2h later over TMC-A.
...
```
raw/source_ohrc_ch2_ohr_ncp_20200825T1521048453_d_img_d18.img  ← PRADAN download required
