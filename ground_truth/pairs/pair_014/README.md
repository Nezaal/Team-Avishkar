# pair_014 — South_Polar_20E

| Field | Value |
|-------|-------|
| OHRC | `ch2_ohr_ncp_20200827T0619368134_d_img_d18` |
...
## OHRC Sensor
- Resolution: 0.2342 m/px | Dims: 91971×12000px
- UL (-64.7257°,19.9946°) UR (-64.7305°,20.2834°)
- LL (-65.5631°,20.1009°) LR (-65.5675°,20.3987°)
...
IIT confirmed. Parallel track, ~20E south polar.
...
```
raw/source_ohrc_ch2_ohr_ncp_20200827T0619368134_d_img_d18.img  ← PRADAN download required
